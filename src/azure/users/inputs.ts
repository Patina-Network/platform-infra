 ...
 *   - Put `objectId` inside of `bootstrapObjectId`
 * 11. Create a PR and ask someone from `@Patina-Network/infra` to review & merge the changes.
 *   - View the Pulumi diff inside of the PR; it will indicate what acceses the user will receive once merged.
 * 12. Wait for the changes to be merged and successfully reconciled by Pulumi (check CICD inside of the latest tag generated by your PR)
...
export const AZURE_USERS = {
  ...
  "Haoking Luo": {
    bootstrapObjectId: "bb0ef4d8-6c73-488a-b010-facaa74bca55",
    entraRoles: ["globalReader"],
